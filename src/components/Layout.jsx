  ...
  return (
    <>
      ...
      <div className="hidden md:block">
        ...
        <main className="min-h-screen bg-gradient-to-br from-gray-50/50 to-gray-100/50 pt-24">
      ...
      <div className="md:hidden">
        <div className="mx-auto min-h-dvh w-full max-w-phone px-0 sm:px-1">
          <div className="relative flex min-h-dvh flex-col overflow-hidden bg-white shadow-2xl sm:min-h-[min(100dvh,920px)] sm:rounded-3xl sm:shadow-3xl">
            ...
            <main className="flex-1 overflow-y-auto px-4 pb-32 pt-6 sm:px-5 sm:pb-32 sm:pt-8 min-[375px]:px-5 bg-gradient-to-b from-white to-gray-50/30">
              <div className="animate-fadeInUp">
                {children}
              </div>
            </main>
